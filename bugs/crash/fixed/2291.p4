...
cpp -C -undef -nostdinc -x assembler-with-cpp  -Ip4_tv/p4c/build/p4include -D__TARGET_BMV2__ -Ip4_tv/p4c/build/p4include -Ip4_tv/p4c/build/p4include ./2291.p4i
...
BMV2::SimpleSwitchMidEnd_25_Predication
BMV2::SimpleSwitchMidEnd_26_MoveDeclarations
BMV2::SimpleSwitchMidEnd_27_ConstantFolding
BMV2::SimpleSwitchMidEnd_28_LocalCopyPropagation
BMV2::SimpleSwitchMidEnd_29_ConstantFolding
BMV2::SimpleSwitchMidEnd_30_SimplifyKey
BMV2::SimpleSwitchMidEnd_31_MoveDeclarations
BMV2::SimpleSwitchMidEnd_32_ValidateTableProperties
BMV2::SimpleSwitchMidEnd_33_SimplifyControlFlow
BMV2::SimpleSwitchMidEnd_34_CompileTimeOperations
BMV2::SimpleSwitchMidEnd_35_TableHit
BMV2::SimpleSwitchMidEnd_36_RemoveLeftSlices
BMV2::SimpleSwitchMidEnd_37_TypeChecking
BMV2::SimpleSwitchMidEnd_38_MidEndLast
BMV2::SimpleSwitchMidEnd_39_EvaluatorPass
BMV2::SimpleSwitchMidEnd_40_VisitFunctor
...
PassManager_13_EvaluatorPass
PassManager_14_VisitFunctor
In file: p4_tv/p4c/backends/bmv2/common/expression.cpp:166
[31mCompiler Bug[0m: bugs/crash/fixed/2291.p4(40): do_function_0(5);: unhandled case
        do_function_0(do_function_0(16w5));
                      ^^^^^^^^^^^^^^^^^^^

running cc -E -C -undef -nostdinc -x assembler-with-cpp -I p4_tv/p4c/build/p4include -o ./2291.p4i bugs/crash/fixed/2291.p4
running p4_tv/p4c/build/p4c-bm2-ss -I p4_tv/p4c/build/p4include --p4v=16 -vvv -o ./2291.json ./2291.p4i --arch v1model
*/
