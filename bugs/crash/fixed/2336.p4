...
cpp -C -undef -nostdinc -x assembler-with-cpp  -Ip4_tv/p4c/build/p4include -D__TARGET_BMV2__ -Ip4_tv/p4c/build/p4include -Ip4_tv/p4c/build/p4include ./2336.p4i
...
P4::TypeChecking_0_ResolveReferences
In file: p4_tv/p4c/frontends/p4/typeChecking/typeChecker.cpp:168
[31mCompiler Bug[0m: bugs/crash/fixed/2336.p4(40): Could not find type of @name("x") c x_0/x(0)
    c(0) x;
         ^

running cc -E -C -undef -nostdinc -x assembler-with-cpp -I p4_tv/p4c/build/p4include -o ./2336.p4i bugs/crash/fixed/2336.p4
running p4_tv/p4c/build/p4c-bm2-ss -I p4_tv/p4c/build/p4include --p4v=16 -vvv -o ./2336.json ./2336.p4i --arch v1model
*/
