...
cpp -C -undef -nostdinc -x assembler-with-cpp  -Ip4_tv/p4c/build/p4include -D__TARGET_BMV2__ -Ip4_tv/p4c/build/p4include -Ip4_tv/p4c/build/p4include ./2102.p4i
...
In file: p4_tv/p4c/ir/visitor.cpp:471
[31mCompiler Bug[0m: visitor returned non-Statement type: <Vector<StatOrDecl>>(14849)

running cc -E -C -undef -nostdinc -x assembler-with-cpp -I p4_tv/p4c/build/p4include -o ./2102.p4i bugs/crash/fixed/2102.p4
running p4_tv/p4c/build/p4c-bm2-ss -I p4_tv/p4c/build/p4include --p4v=16 -vvv -o ./2102.json ./2102.p4i --arch v1model
*/
