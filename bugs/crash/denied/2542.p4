...
cpp -C -undef -nostdinc -x assembler-with-cpp  -D__TARGET_BMV2__ -Ip4c/build/p4include bugs/crash/ctrl_inline.p4
...
bugs/crash/ctrl_inline.p4(26): [--Werror=not-found] error: eth_type: declaration not found
