...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        HeaderType("H", z3_reg, z3_args=[("a", z3.BitVecSort(8)), ("b", z3.BitVecSort(8)), ])
    )
    z3_reg.declare_global(
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("in", "eth_type", z3.BitVecSort(16), None),
                P4Parameter("out", "dummy_val", z3.BitVecSort(8), None),],
            const_params=[],
            body=BlockStatement([]
            ),
            local_decls=[]
    ...
    z3_reg.declare_global(
        P4Declaration("inline_dummy", P4Function("inline_dummy", return_type=None, params=[
            P4Parameter("in", "eth_type", z3.BitVecSort(16), None),
            P4Parameter("out", "dummy_val", z3.BitVecSort(8), None),],         body=BlockStatement([]
        )        )        )
    )
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("sub_c_0", "apply"), [], P4Member(P4Member("h", "eth_hdr"), "eth_type"), P4Member(P4Member("h", "h"), "a"), )),
                MethodCallStmt(MethodCallExpr("inline_dummy", [], P4Member(P4Member("h", "eth_hdr"), "eth_type"), P4Member(P4Member("h", "h"), "b"), )),]
            ),
            local_decls=[
InstanceDeclaration("sub_c_0", "sub_ctrl", ), ]
        ))
    )
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
