...
parser parserImpl(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name("p1.ipv4_ethertypes") value_set<bit<16>>(8) p1_ipv4_ethertypes_0;
    @name("p2.ipv4_ethertypes") value_set<bit<16>>(8) p2_ipv4_ethertypes_0;
    state start {
    ...
    state subParser_start {
        ...
        transition select(hdr.ethernet_1.etherType) {
            p1_ipv4_ethertypes_0: subParser_parse_ipv4;
            default: start_0;
        }
    }
    ...
    state subParser_start_0 {
        ...
        transition select(hdr.ethernet_2.etherType) {
            p2_ipv4_ethertypes_0: subParser_parse_ipv4_0;
            default: start_1;
        }
    }
