*** dumps/p4_16_samples/checksum3-bmv2.p4/pruned/checksum3-bmv2-BMV2::SimpleSwitchMidEnd_15_StrengthReduction.p4	2019-05-20 16:58:03.439831600 +0200
--- dumps/p4_16_samples/checksum3-bmv2.p4/pruned/checksum3-bmv2-BMV2::SimpleSwitchMidEnd_16_EliminateTuples.p4	2019-05-20 16:58:03.442152600 +0200
*************** control vc(inout headers hdr, inout meta
*** 90,98 ****
      apply {
      }
  }
