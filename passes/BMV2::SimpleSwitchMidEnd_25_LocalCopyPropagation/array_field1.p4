*** dumps/p4_16_samples/array_field1.p4/pruned/array_field1-BMV2::SimpleSwitchMidEnd_24_ConstantFolding.p4	2019-05-20 16:57:54.780685300 +0200
...
*************** extern bit<1> f(inout bit<1> x, in bit<1
*** 5,37 ****
  control c(out H[2] h);
  package top(c _c);
