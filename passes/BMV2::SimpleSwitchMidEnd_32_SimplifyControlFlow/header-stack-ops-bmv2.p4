--- before_pass
+++ after_pass
@@ -56,9 +56,7 @@ parser parserI(packet_in pkt, out header
...
@@ -156,9 +154,7 @@ control cIngress(inout headers hdr, inou
                                         else 
...
@@ -256,9 +252,7 @@ control cIngress(inout headers hdr, inou
                                         else 
...
@@ -356,9 +350,7 @@ control cIngress(inout headers hdr, inou
                                         else 
...
@@ -387,13 +379,11 @@ control uc(inout headers hdr, inout meta
