...
@@ -219,106 +217,98 @@ control ingress(inout headers hdr, inout
...
@@ -357,55 +347,51 @@ control ingress(inout headers hdr, inout
...
@@ -429,58 +415,56 @@ control DeparserImpl(packet_out packet,
